...
if [ ! -d ${split_pruned_dir} ]; then
    python3 ~/DeepMicrobes/scripts/split_fasta_5000.py ${split_pruned_dir}
    echo "INFO: done python3 ~/DeepMicrobes/scripts/split_fasta_5000.py ${split_pruned_dir}"
else
    echo "INFO: skip python3 ~/DeepMicrobes/scripts/split_fasta_5000.py ${split_pruned_dir}"
fi
