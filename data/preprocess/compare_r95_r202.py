...
print("checking representative genome changes in r95 and r202")
...
for index, row in r95.iterrows():
    ...
    if r202_row['GTDB_species'] != row['GTDB_species']:
        print(index+":", "FROM")
        print(row['GTDB_taxonomy']+";"+row['GTDB_species'], "TO")
        print(r202_row['GTDB_taxonomy']+";"+r202_row['GTDB_species'])