...
# curl urls
os.mkdir("/mnt/sda/DeepMicrobes-data/ERP108418")
for url in download_urls:
    os.system("(cd /mnt/sda/DeepMicrobes-data/ERP108418 && curl -O -L "+url+")")
    print("(cd /mnt/sda/DeepMicrobes-data/ERP108418 && curl -O -L "+url+")"+" done")
