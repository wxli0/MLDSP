function [tab,mList1,mList2,mList3,mList4,mList5,mList6] = testingExternMisList(dSet,numMethod,disMat,alabels,lg,clusterNames,kVal,mLen,minSeqLen,maxSeqLen,maxClusSize, clusterStart)
     warning('off','all');
...
%     end
    ...
    %testing
    [pMat,mList1,mList2,mList3,mList4,mList5,mList6] = classifyTestSeqExternMisList(AcNmbTest,numMethod,disMat,alabels,SeqTest,lg,clusterNames,kVal,mLen, clusterStart);
